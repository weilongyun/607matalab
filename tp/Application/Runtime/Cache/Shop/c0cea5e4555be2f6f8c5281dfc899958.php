...
<script type="text/javascript" src="/tp/Public/Scripts/pz.js"></script>
    <script type="text/javascript" src="/tp/Public/Scripts/geo.js"></script
...
<div id="page">
  ...
  <div class="main">
      ...
      <form action="<?php echo U('Index/weixinzhifu');?>" method="post">
    <div class="details_text">
      <div class="details_title" name="name"><?php echo ($data['name']); ?> <?php echo ($data['guige']); ?></div>
     ...
     <!-- <div class="details_dq">         <div class="details_dq_left left">配送区域：</div>
      ...
      <div class="details_nr">服务承诺：<span id="isSupportCOD"></span><span id="service">送货入户（违约赔付100元），送装同步</span><span id="limit"></span></div>
          ...
          <input type="text" maxlength="2"  name="num" value="<?php echo ($data['num']); ?>" id="proCount" readonly="readonly">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
          ...
          <td height="45" align="left" valign="middle" width="80%"><input type="text" id="name" name="username" value="" class="tz_wbk"></td>
      </tr>
      <tr>
    ...
    <tr>
        <td height="45" align="right" valign="middle">地 址：</td>
    ...
    <tr>
        ...
        <td height="45" align="left" valign="middle"><input type="text"   name="xiangxidizhi" value=""  class="tz_wbk"></td>
    </tr>
</table>
...
<!--</div>-->
<!--<div class="details_qh" style="display:none" id="tongzhi"><a href="javascript:void(0);" class="dhtz">到货通知</a></div>
<div class="details_qh" style="display:none" id="wu"><a href="javascript:void(0)">无货</a></div>-->
<!---======到货通知=====-->
