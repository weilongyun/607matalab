<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"C:\wamp\www\tp5\application\admin\view\index\index.html";i:1461144239;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo U('product_category'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
